...
export default function DetailStickyCard({ title, price }: IPropsDetailStickyCard) {
    return (
        <div className="sticky top-20 flex flex-col gap-6 p-6 bg-white border border-[#DDDDDD] rounded-2xl">
            ...
            <div className="flex w-full justify-between items-center">
                <div className="flex gap-2 items-center">
                    ...
                    <span className="text-[32px] text-[#1A1A1A] font-medium">4.9 <span className="text-base text-[#888888]"> / 5.0</span></span>
                </div>
